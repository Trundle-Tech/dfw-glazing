    ...
    <div className="flex flex-col">
          ...
          <FadeIn direction="up">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center mb-12">
                <div className="w-12 h-12 bg-[#0e8c21] rounded-lg flex items-center justify-center mr-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <FadeIn key={value.title} delay={index * 0.1} direction="up">
                <Card className="h-full border-2 border-gray-200 hover:border-[#0e8c21] hover:shadow-2xl transition-all duration-300">
                  <CardContent className="p-6">
                    <div className="w-16 h-16 bg-[#0e8c21] rounded-lg flex items-center justify-center mb-4">
      ...
      <section className="py-20 bg-black text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <FadeIn direction="up">
              <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Our Objectives</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {objectives.map((objective, index) => (
                <FadeIn key={index} delay={index * 0.05} direction="up">
                  <Card className="h-full bg-white border-2 border-white hover:border-[#0e8c21] hover:shadow-2xl transition-all duration-300">
                    <CardContent className="p-6">
      ...
      <section className="py-20 bg-[#0e8c21] text-white">
        <div className="container mx-auto px-4 text-center">
          <FadeIn direction="up">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Experience the DFW Glazing Difference</h2>
